...
CREATE TABLE `order` (
  ...
  `to_user_id` int(11) NOT NULL COMMENT '交易人',
  `to_user_name` varchar(80) DEFAULT NULL COMMENT '交易人姓名',
...
CREATE TABLE `user_address` (
  ...
  `user_id` int(11) NOT NULL COMMENT '外键，user表',
  `update_time` int(11) DEFAULT NULL,
  `delete_time` int(11) DEFAULT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `user_id` (`user_id`)
) ENGINE=InnoDB AUTO_INCREMENT=35 DEFAULT CHARSET=utf8mb4 COMMENT='用户收货地址，一对一关系，每个用户一条记录';
